# -*- coding: utf-8 -*-
#
# urban_type_editor documentation build configuration file, created by
...
latex_documents = [
  ('index', 'urban_type_editor.tex', u'urban_type_editor Documentation',
...
man_pages = [
    ('index', 'TemplateClass', u'urban_type_editor Documentation',
